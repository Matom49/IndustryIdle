export const EN = {
    ...
    Engine: "Motor",
    EngineFactory: "Továrna na motory",
    ...
    MissileFactory: "Továrna na řízené střely",
    Rocket: "Raketa",
    RocketFactory: "Továrna na rakety",
    ...
    SolarPanelDesc: "💡 Solární panely fungují 5 vteřin z každých 10 vteřin - všechny výpadky jsou ve stejnou chvíli",
    WindTurbineDesc: "💡 Větrné turbíny fungují 8 vteřin z každých 10 vteřin - cykly jsou různé.",
    Movie: "FIlm",
    MovieStudio: "Filmové studio",
    Sitcom: "Sitcom",
    TVStudio: "TV Studio",
    PC: "Počítač",
    GameStudio: "Herní studio",
    Game: "Hra",
    ComputerFactory: "Firma na počítače",
    Shipyard: "LOděnice",
    PowerUsage: "Využití energie",
    ...
    ResourceInput: "Do",
    ResourceOutput: "Z",
    ResourceStorage: "Uložiště",
    ResourceChange: "Změna",
    ResourceInOutDesc: "💡 Tap on Out-In numbers above to highlight the corresponding output and input buildings",
    MarketUpdateIn: "Aktualizace trhu za %{time}",
    Semiconductor: "Polovodič",
    SemiconductorFactory: "Továrna na polovodiče",
    Steel: "OCel",
    Bitcoin: "Bitcoin",
    BitcoinFarm: "Farma na bitcoin",
    Dogecoin: "Dogecoin",
    DogecoinFarm: "Farma na dogecoin",
    Guitar: "Kytara",
    GuitarFactory: "Továrna na kytary",
    Drum: "Bicí",
    DrumFactory: "Továrna na bicí",
    RecordingStudio: "Nahrávací studio",
    OperaHouse: "Operní dům",
    CoalGasificationPlant: "Závod na zplyňování uhlí",
    GasProcessingPlant: "Závod na zpracování plynu",
    Music: "Hudba",
    Glass: "SKlo",
    PhoneFactory: "Továrna na mobily",
    Phone: "Mobil",
    GlassFactory: "Sklárna",
    Oil: "Olej",
    Chromium: "Chrom",
    ChromiumMine: "Chromový důl",
    Uranium: "Uran",
    EnrichedUranium: "Obohacený uran",
    NuclearPowerPlant: "Jaderná elektrárna",
    UraniumEnrichmentPlant: "Závod na obohacování uranu",
    UraniumMine: "Uranový důl",
    Titanium: "Titan",
    TitaniumMine: "Titanový důl",
    TitaniumAlloyPlant: "Závod na výrobu titanových slitin",
    ChromiumAlloyPlant: "Závod na výrobu chromových slitin",
    Input: "Vstup",
    PanelPosition: "Pozice panelu",
    Output: "Výstup",
    OutputCapacity: "Výstupní kapacita",
    ResourceDeposit: "Ložisko surovin",
    AdjacentBonus: "Přilehlý bonus",
    AdjacentBonusDesc: "Dostaneš%{bonus}% extra capacity za každou přilehlou pracující budovu stejného typu",
    ConsiderIncreaseProduction: "💡 Uvažuj nad zvýšením produkce %{resource}",
    ProductionCycleLength: "Výrobní cyklus",
